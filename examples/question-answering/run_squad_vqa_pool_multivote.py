...
from transformers import (
    MODEL_FOR_QUESTION_ANSWERING_VQAPool_MultiVote_MAPPING as MODEL_FOR_QUESTION_ANSWERING_VQA_MAPPING,
    WEIGHTS_NAME,
    AdamW,
    AutoConfig,
    AutoModelForQuestionAnsweringVQAPool_MultiVote as AutoModelForQuestionAnswering,
    AutoTokenizer,
