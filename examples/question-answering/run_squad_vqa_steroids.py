...
from transformers import (
    MODEL_FOR_QUESTION_ANSWERING_STEROIDS_MAPPING as MODEL_FOR_QUESTION_ANSWERING_VQA_MAPPING,
    WEIGHTS_NAME,
    AdamW,
    AutoConfig,
    AutoModelForQuestionAnsweringVQASteroids as AutoModelForQuestionAnswering,
    AutoTokenizer,
