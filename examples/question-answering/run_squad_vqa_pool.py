...
from transformers import (
    MODEL_FOR_QUESTION_ANSWERING_VQAPool_MAPPING as MODEL_FOR_QUESTION_ANSWERING_VQA_MAPPING,
    WEIGHTS_NAME,
    AdamW,
    AutoConfig,
    AutoModelForQuestionAnsweringVQAPool as AutoModelForQuestionAnswering,
    AutoTokenizer,
