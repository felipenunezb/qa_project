...
from transformers import (
    MODEL_FOR_QUESTION_ANSWERING_SGNet_MAPPING as MODEL_FOR_QUESTION_ANSWERING_VQA_MAPPING,
    WEIGHTS_NAME,
    AdamW,
    AutoConfig,
    AutoModelForQuestionAnswering_SGNet as AutoModelForQuestionAnswering,
    AutoTokenizer,
    get_linear_schedule_with_warmup,
    #squad_convert_examples_to_features,
)
from transformers.data.processors.squad_vqa_sgnet import squad_convert_examples_to_features
...
from transformers.data.processors.squad_vqa_sgnet import SquadResult, SquadV1Processor, SquadV2Processor, SquadProcessor, initializeWordEmbeddings
...
def evaluate(args, model, tokenizer, prefix=""):
    ...
    for batch in tqdm(eval_dataloader, desc="Evaluating"):
        ...
        input_size = len(batch[0][0])

        input_span_mask = np.zeros((batch_size, input_size, input_size))
        for batch_idx in range(batch_size):
            train_feature = features[batch[7][batch_idx]]
