...
from .modeling_bert import (
    ...
    BertForQuestionAnsweringVQA_SGNet,
)
...
from .modeling_electra import (
    ...
    ElectraForQuestionAnsweringSteroids,
    ElectraForQuestionAnsweringEnriched,
...
MODEL_FOR_QUESTION_ANSWERING_AV_MAPPING = OrderedDict(
    [
        (DistilBertConfig, DistilBertForQuestionAnswering),
        (AlbertConfig, AlbertForQuestionAnsweringAV),
        (CamembertConfig, CamembertForQuestionAnswering),
        (BartConfig, BartForQuestionAnswering),
        (LongformerConfig, LongformerForQuestionAnswering),
        (XLMRobertaConfig, XLMRobertaForQuestionAnswering),
...
MODEL_FOR_QUESTION_ANSWERING_AVPool_MAPPING = OrderedDict(
    [
        (DistilBertConfig, DistilBertForQuestionAnswering),
        (AlbertConfig, AlbertForQuestionAnsweringAVPool),
        (CamembertConfig, CamembertForQuestionAnswering),
        (BartConfig, BartForQuestionAnswering),
        (LongformerConfig, LongformerForQuestionAnswering),
        (XLMRobertaConfig, XLMRobertaForQuestionAnswering),
...
MODEL_FOR_QUESTION_ANSWERING_VQAPool_MAPPING = OrderedDict(
    [
        ...
        (BertConfig, BertForQuestionAnswering),
        (ElectraConfig, ElectraForQuestionAnsweringVQAPool),
    ]
)

MODEL_FOR_QUESTION_ANSWERING_VQAPool_MultiVote_MAPPING = OrderedDict(
    [
        (AlbertConfig, AlbertForQuestionAnsweringVQAPool),
...
MODEL_FOR_QUESTION_ANSWERING_STEROIDS_MAPPING = OrderedDict(
    [
        ...
        (ElectraConfig, ElectraForQuestionAnsweringSteroids),
    ]
)

MODEL_FOR_QUESTION_ANSWERING_VanillaSG_MAPPING = OrderedDict(
    [
        (BertConfig, BertForQuestionAnsweringVanillaSG),
    ]
)
...
MODEL_FOR_QUESTION_ANSWERING_E_MAPPING = OrderedDict(
    [
        ...
        (ElectraConfig, ElectraForQuestionAnsweringEnriched),
    ]
)

MODEL_FOR_QUESTION_ANSWERING_SGNet_MAPPING = OrderedDict(
    [
        (BertConfig, BertForQuestionAnsweringVQA_SGNet),
    ]
)
...
class AutoModelForQuestionAnsweringAV:
    r"""
        :class:`~transformers.AutoModelForQuestionAnswering` is a generic model class
        that will be instantiated as one of the question answering model classes of the library
        when created with the `AutoModelForQuestionAnswering.from_pretrained(pretrained_model_name_or_path)`
    ...
    def from_config(cls, config):
        ...
        Examples::
            ...
            model = AutoModelForQuestionAnswering.from_config(config)  # E.g. model was saved using `save_pretrained('./test/saved_model/')`
        """
        for config_class, model_class in MODEL_FOR_QUESTION_ANSWERING_AV_MAPPING.items():
            if isinstance(config, config_class):
                return model_class(config)
        ...
        raise ValueError(
            ...
            "Model type should be one of {}.".format(
                config.__class__,
                cls.__name__,
                ", ".join(c.__name__ for c in MODEL_FOR_QUESTION_ANSWERING_AV_MAPPING.keys()),
            )
        )
...
class AutoModelForQuestionAnsweringAVPool:
    r"""
        :class:`~transformers.AutoModelForQuestionAnswering` is a generic model class
        that will be instantiated as one of the question answering model classes of the library
        when created with the `AutoModelForQuestionAnswering.from_pretrained(pretrained_model_name_or_path)`
    ...
    def from_config(cls, config):
        ...
        Examples::
            ...
            model = AutoModelForQuestionAnswering.from_config(config)  # E.g. model was saved using `save_pretrained('./test/saved_model/')`
        """
        for config_class, model_class in MODEL_FOR_QUESTION_ANSWERING_AVPool_MAPPING.items():
            if isinstance(config, config_class):
                return model_class(config)
        ...
        raise ValueError(
            ...
            "Model type should be one of {}.".format(
                config.__class__,
                cls.__name__,
                ", ".join(c.__name__ for c in MODEL_FOR_QUESTION_ANSWERING_AVPool_MAPPING.keys()),
            )
        )
...
class AutoModelForQuestionAnsweringVQA:
    r"""
        :class:`~transformers.AutoModelForQuestionAnswering` is a generic model class
        that will be instantiated as one of the question answering model classes of the library
        when created with the `AutoModelForQuestionAnswering.from_pretrained(pretrained_model_name_or_path)`
    ...
    def from_config(cls, config):
        ...
        Examples::
            ...
            model = AutoModelForQuestionAnswering.from_config(config)  # E.g. model was saved using `save_pretrained('./test/saved_model/')`
        """
        for config_class, model_class in MODEL_FOR_QUESTION_ANSWERING_VQA_MAPPING.items():
            if isinstance(config, config_class):
                return model_class(config)
        ...
        raise ValueError(
            ...
            "Model type should be one of {}.".format(
                config.__class__,
                cls.__name__,
                ", ".join(c.__name__ for c in MODEL_FOR_QUESTION_ANSWERING_VQA_MAPPING.keys()),
            )
        )
...
class AutoModelForQuestionAnsweringVQAPool:
    r"""
        :class:`~transformers.AutoModelForQuestionAnswering` is a generic model class
        that will be instantiated as one of the question answering model classes of the library
        when created with the `AutoModelForQuestionAnswering.from_pretrained(pretrained_model_name_or_path)`
    ...
    def from_config(cls, config):
        ...
        Examples::
            ...
            model = AutoModelForQuestionAnswering.from_config(config)  # E.g. model was saved using `save_pretrained('./test/saved_model/')`
        """
        for config_class, model_class in MODEL_FOR_QUESTION_ANSWERING_VQAPool_MAPPING.items():
            if isinstance(config, config_class):
                return model_class(config)
        ...
        raise ValueError(
            ...
            "Model type should be one of {}.".format(
                config.__class__,
                cls.__name__,
                ", ".join(c.__name__ for c in MODEL_FOR_QUESTION_ANSWERING_VQAPool_MAPPING.keys()),
            )
        )
...
class AutoModelForQuestionAnsweringVQAPool_MultiVote:
    r"""
        :class:`~transformers.AutoModelForQuestionAnswering` is a generic model class
        that will be instantiated as one of the question answering model classes of the library
        when created with the `AutoModelForQuestionAnswering.from_pretrained(pretrained_model_name_or_path)`
    ...
    def from_config(cls, config):
        ...
        Examples::
            ...
            model = AutoModelForQuestionAnswering.from_config(config)  # E.g. model was saved using `save_pretrained('./test/saved_model/')`
        """
        for config_class, model_class in MODEL_FOR_QUESTION_ANSWERING_VQAPool_MultiVote_MAPPING.items():
            if isinstance(config, config_class):
                return model_class(config)
        ...
        raise ValueError(
            ...
            "Model type should be one of {}.".format(
                config.__class__,
                cls.__name__,
                ", ".join(c.__name__ for c in MODEL_FOR_QUESTION_ANSWERING_VQAPool_MultiVote_MAPPING.keys()),
            )
        )
...
class AutoModelForQuestionAnsweringVQA_VanillaSG:
    r"""
        :class:`~transformers.AutoModelForQuestionAnswering` is a generic model class
        that will be instantiated as one of the question answering model classes of the library
        when created with the `AutoModelForQuestionAnswering.from_pretrained(pretrained_model_name_or_path)`
    ...
    def from_config(cls, config):
        ...
        Examples::
            ...
            model = AutoModelForQuestionAnswering.from_config(config)  # E.g. model was saved using `save_pretrained('./test/saved_model/')`
        """
        for config_class, model_class in MODEL_FOR_QUESTION_ANSWERING_VanillaSG_MAPPING.items():
            if isinstance(config, config_class):
                return model_class(config)
        ...
        raise ValueError(
            ...
            "Model type should be one of {}.".format(
                config.__class__,
                cls.__name__,
                ", ".join(c.__name__ for c in MODEL_FOR_QUESTION_ANSWERING_VanillaSG_MAPPING.keys()),
            )
        )
...
class AutoModelForQuestionAnsweringSteroids:
    r"""
        :class:`~transformers.AutoModelForQuestionAnswering` is a generic model class
        that will be instantiated as one of the question answering model classes of the library
        when created with the `AutoModelForQuestionAnswering.from_pretrained(pretrained_model_name_or_path)`
    ...
    def from_config(cls, config):
        ...
        Examples::
            ...
            model = AutoModelForQuestionAnswering.from_config(config)  # E.g. model was saved using `save_pretrained('./test/saved_model/')`
        """
        for config_class, model_class in MODEL_FOR_QUESTION_ANSWERING_STEROIDS_MAPPING.items():
            if isinstance(config, config_class):
                return model_class(config)
        ...
        raise ValueError(
            ...
            "Model type should be one of {}.".format(
                config.__class__,
                cls.__name__,
                ", ".join(c.__name__ for c in MODEL_FOR_QUESTION_ANSWERING_STEROIDS_MAPPING.keys()),
            )
        )
...
class AutoModelForQuestionAnsweringSteroidsSG:
    r"""
        :class:`~transformers.AutoModelForQuestionAnswering` is a generic model class
        that will be instantiated as one of the question answering model classes of the library
        when created with the `AutoModelForQuestionAnswering.from_pretrained(pretrained_model_name_or_path)`
    ...
    def from_config(cls, config):
        ...
        Examples::
            ...
            model = AutoModelForQuestionAnswering.from_config(config)  # E.g. model was saved using `save_pretrained('./test/saved_model/')`
        """
        for config_class, model_class in MODEL_FOR_QUESTION_ANSWERING_STEROIDSSG_MAPPING.items():
            if isinstance(config, config_class):
                return model_class(config)
        ...
        raise ValueError(
            ...
            "Model type should be one of {}.".format(
                config.__class__,
                cls.__name__,
                ", ".join(c.__name__ for c in MODEL_FOR_QUESTION_ANSWERING_STEROIDSSG_MAPPING.keys()),
            )
        )
...
class AutoModelForQuestionAnsweringE:
    r"""
        :class:`~transformers.AutoModelForQuestionAnswering` is a generic model class
        that will be instantiated as one of the question answering model classes of the library
        when created with the `AutoModelForQuestionAnswering.from_pretrained(pretrained_model_name_or_path)`
    ...
    def from_config(cls, config):
        ...
        Examples::
            ...
            model = AutoModelForQuestionAnswering.from_config(config)  # E.g. model was saved using `save_pretrained('./test/saved_model/')`
        """
        for config_class, model_class in MODEL_FOR_QUESTION_ANSWERING_E_MAPPING.items():
            if isinstance(config, config_class):
                return model_class(config)
        ...
        raise ValueError(
            ...
            "Model type should be one of {}.".format(
                config.__class__,
                cls.__name__,
                ", ".join(c.__name__ for c in MODEL_FOR_QUESTION_ANSWERING_E_MAPPING.keys()),
            )
        )
...
class AutoModelForQuestionAnswering_SGNet:
    r"""
        :class:`~transformers.AutoModelForQuestionAnswering` is a generic model class
        that will be instantiated as one of the question answering model classes of the library
        when created with the `AutoModelForQuestionAnswering.from_pretrained(pretrained_model_name_or_path)`
    ...
    def from_config(cls, config):
        ...
        Examples::
            ...
            model = AutoModelForQuestionAnswering.from_config(config)  # E.g. model was saved using `save_pretrained('./test/saved_model/')`
        """
        for config_class, model_class in MODEL_FOR_QUESTION_ANSWERING_SGNet_MAPPING.items():
            if isinstance(config, config_class):
                return model_class(config)
        ...
        raise ValueError(
            ...
            "Model type should be one of {}.".format(
                config.__class__,
                cls.__name__,
                ", ".join(c.__name__ for c in MODEL_FOR_QUESTION_ANSWERING_SGNet_MAPPING.keys()),
            )
        )
