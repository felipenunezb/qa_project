...
def squad_convert_examples_to_features(
    ...
    if return_dataset == "pt":
        ...
        all_title = torch.tensor([f.title for f in features], dtype=torch.long) #f.title
...
class SquadProcessor(DataProcessor):
    ...
    def get_dev_examples(self, data_dir, filename=None, to_ix_dict=None):
        ...
        with open(
            ...
            input_data = json.load(reader)["data"]
        return self._create_examples(input_data, "dev", to_ix_dict)

    def _create_examples(self, input_data, set_type, to_ix_dict):
