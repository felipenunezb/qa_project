...
from ..processors.squad_vqa_sgnet import SquadFeatures, SquadV1Processor, SquadV2Processor, squad_convert_examples_to_features
...
class SquadDataTrainingArguments:
    ...
    input_tag_file: str = field(
        default=None, metadata={"help": "The input tag file."}
    )
...
class SquadDataset(Dataset):
    ...
    def __getitem__(self, i) -> Dict[str, torch.Tensor]:
        ...
        print(len(feature.input_span_mask))
        print(feature.input_span_mask)
        print(input_span_mask.size())
